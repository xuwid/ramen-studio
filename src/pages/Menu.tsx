...
const Menu = () => {
  ...
  return (
    <div className="min-h-screen py-8 palette-atmosphere">
      <div className="container mx-auto px-4">
        {/* Header */}
        <div className="text-center mb-12 slide-up">
          <h1 className="text-5xl font-bold mb-4 palette-text">
            �‍🍳 Our Korean Ramen Menu �‍🍳
          </h1>
          <p className="text-xl text-palette-rose-red max-w-2xl mx-auto fade-in" style={{ animationDelay: '0.2s' }}>
        ...
        <section className="mb-16 mt-16">
          <h2 className="text-3xl font-bold text-center mb-8 palette-text slide-up">
            🐾 Ramen Base Options 🐾
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {ramenOptions.map((ramen, index) => (
                <Card key={index} className="palette-card fade-in overflow-hidden border-2 border-palette-red-violet/20" style={{ animationDelay: `${0.1 * index}s` }}>
